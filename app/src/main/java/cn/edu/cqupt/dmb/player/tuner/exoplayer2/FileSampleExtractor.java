...
public class FileSampleExtractor implements SampleExtractor {
    ...
    private Format createFormat(MediaFormat mediaFormat) {
        ...
        int maxInputSize =
                getOptionalIntegerV16(mediaFormat, MediaFormat.KEY_MAX_INPUT_SIZE);
        ...
        int channelCount =
                getOptionalIntegerV16(mediaFormat, MediaFormat.KEY_CHANNEL_COUNT);
        int sampleRate =
                getOptionalIntegerV16(mediaFormat, MediaFormat.KEY_SAMPLE_RATE);
        ...
        long durationUs =
                mediaFormat.containsKey(MediaFormat.KEY_DURATION)
