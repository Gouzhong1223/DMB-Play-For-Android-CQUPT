...
public class LineupFragment extends SetupMultiPaneFragment {
    ...
    public static final String ACTION_CATEGORY = "cn.edu.cqupt.dmb.player.tuner.setup.LineupFragment";
            ...
            if ((lineups != null && lineups.isEmpty()) || this.lineupNotFound) {
                actions.add(
                        new GuidedAction.Builder(getActivity())
                                .id(ACTION_ID_RETRY)
                                .title(R.string.action_text_retry)
                                .build());
                actions.add(
                        new GuidedAction.Builder(getActivity())
                                .id(ACTION_SKIP)
                                .title(R.string.action_text_skip)
                                .build());
            } else if (lineups == null) {
                actions.add(
                        new GuidedAction.Builder(getActivity())
