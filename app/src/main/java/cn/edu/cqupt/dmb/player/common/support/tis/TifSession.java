 ...
 */
package cn.edu.cqupt.dmb.player.common.support.tis;
...
/**
 * Custom {@link Session} class that uses delegation and a callback
...
public abstract class TifSession {
    ...
    /**
     * Callbacks used to notify the {@link Session}.
     *
