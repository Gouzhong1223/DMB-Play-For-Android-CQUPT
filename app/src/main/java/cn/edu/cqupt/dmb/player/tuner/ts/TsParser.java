...
package cn.edu.cqupt.dmb.player.tuner.ts;
...
import cn.edu.cqupt.dmb.player.tuner.data.SectionParser;
import cn.edu.cqupt.dmb.player.tuner.data.SectionParser.OutputListener;
...
public class TsParser {
    ...
    private class SectionStream extends Stream {
        ...
        public SectionStream(int pid) {
            ...
            OutputListener mSectionListener = new OutputListener() {
                @Override
