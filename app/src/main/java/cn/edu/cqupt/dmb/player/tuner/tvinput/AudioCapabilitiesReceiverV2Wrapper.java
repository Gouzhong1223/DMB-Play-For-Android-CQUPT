 ...
 * custom threads.
 */
public final class AudioCapabilitiesReceiverV2Wrapper {

    private static final String TAG = "AudioCapabilitiesReceiverV2Wrapper";
     ...
     */
    public AudioCapabilitiesReceiverV2Wrapper(
