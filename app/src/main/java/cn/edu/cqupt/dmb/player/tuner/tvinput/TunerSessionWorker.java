...
import cn.edu.cqupt.dmb.player.common.TvContentRatingCache;
import cn.edu.cqupt.dmb.player.common.compat.TvInputConstantCompat;
import cn.edu.cqupt.dmb.player.common.customization.CustomizationManager;
import cn.edu.cqupt.dmb.player.common.customization.CustomizationManager.TRICKPLAY_MODE;
...
import cn.edu.cqupt.dmb.player.tuner.data.PsipData.TvTracksInterface;
...
import cn.edu.cqupt.dmb.player.tuner.exoplayer.MpegTsPlayer;
...
import cn.edu.cqupt.dmb.player.tuner.exoplayer.buffer.BufferManager.StorageManager;
import cn.edu.cqupt.dmb.player.tuner.exoplayer.buffer.DvrStorageManager;
import cn.edu.cqupt.dmb.player.tuner.exoplayer.buffer.PlaybackBufferListener;
import cn.edu.cqupt.dmb.player.tuner.exoplayer.buffer.TrickplayStorageManager;
...
public class TunerSessionWorker
    ...
    private static final Semaphore sActiveSessionSemaphore = new Semaphore(1);
    ...
    private boolean handleMessageSmoothTrickplayMonitor() {
        ...
        long systemCurrentTime = System.currentTimeMillis();
        @SuppressLint("WrongThread") long position = getCurrentPosition();
        if (mRecordingId == null) {
