...
import cn.edu.cqupt.dmb.player.tuner.source.FileTsStreamer;
import cn.edu.cqupt.dmb.player.tuner.source.TsDataSource;
import cn.edu.cqupt.dmb.player.tuner.source.TsStreamer;
import cn.edu.cqupt.dmb.player.tuner.source.TunerTsStreamer;
...
public class ScanFragment extends SetupFragment {
    ...
    private class ChannelScanTask extends AsyncTask<Void, Integer, Void>
        ...
        private final cn.edu.cqupt.dmb.player.tuner.hdhomerun.HdHomeRunTunerHal mNetworkTuner;
        ...
        public ChannelScanTask(int channelMapId) {
            ...
            if (FAKE_MODE) {
                ...
                if (hal instanceof cn.edu.cqupt.dmb.player.tuner.hdhomerun.HdHomeRunTunerHal) {
                    mNetworkTuner = (cn.edu.cqupt.dmb.player.tuner.hdhomerun.HdHomeRunTunerHal) hal;
                } else {
                    mNetworkTuner = null;
                }
        ...
        protected Void doInBackground(Void... params) {
            if (mNetworkTuner != null) {
                ...
                cn.edu.cqupt.dmb.player.tuner.hdhomerun.HdHomeRunChannelScan hdHomeRunChannelScan =
                        new cn.edu.cqupt.dmb.player.tuner.hdhomerun.HdHomeRunChannelScan(
